...
const variantClasses: Record<Variant, string> = {
  ...
  danger: "bg-rose-600 text-white shadow-xs hover:bg-rose-500 active:bg-rose-700",
  ...
  ({ className, variant = "secondary", size = "md", disabled, asChild, loading, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          "inline-flex items-center justify-center rounded-lg font-medium transition-all duration-150 whitespace-nowrap select-none",
