export const APP_NAME = "Atlas Forms";
export const APP_DESCRIPTION = "Create and manage forms with ease";
export const ASSISTANT_NAME = "Atlas Forms Assistant";

export const TEXT_WELCOME_BACK = "Welcome Back";
export const TEXT_DESCRIPTION = "Atlas Forms is your professional form builder, helping you create and manage forms with ease.";
...
export const TEXT_COPYRIGHT = "2026 Atlas Forms. All rights reserved.";
